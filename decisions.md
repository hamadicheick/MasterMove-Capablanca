...
011 - Le texte narratif est ecrit directement en francais parlable. Pas de notation brute (Cxf2, Fb4+), pas de symboles (x, +, #). Ex : "cavalier prend en f2", "fou en b4, echec". Reference : CONVENTIONS_NARRATION.md
